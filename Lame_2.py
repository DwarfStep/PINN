...
''' ansys'''
ans =[-1000049.6250000002, -1045224.2300000000, -1088318.5850000002, -1129458.7700000005, -1168761.0100000000, -1206332.8374999999, -1242274.2849999999, -1276678.0899999999, -1309630.6125000003, -1341212.2475000005, -1371497.7375000005, -1400557.1250000005, -1428455.5000000009, -1455242.5000000005, -1480976.9300000006, -1505723.9250000003, -1529533.2125000004, -1552451.5575000001, -1574522.6525000003, -1595787.7400000002, -1616285.5750000004, -1636052.4549999998, -1655122.7650000004, -1673528.7799999998, -1691300.8650000000, -1708467.8750000007, -1725044.9200000006, -1741070.6175000002, -1756569.1975000002, -1771563.3975000004, -1786074.8875000007, -1800124.0825000005, -1813730.4450000005, -1826912.2400000007, -1839687.0925000007, -1852071.3375000008, -1864080.8925000005, -1875730.7025000008, -1887031.2225000011, -1897996.4475000007, -1908643.0125000007, -1918983.1575000007, -1929028.4525000011, -1938789.9625000006, -1948278.2700000014, -1957503.4625000008, -1966475.1800000011, -1975202.5575000010, -1983694.4650000012, -1991959.1700000006, -2000004.8750000005]
ans = [i/1e6 for i in ans]
Xk = np.linspace(0.25, 0.45, len(ans))
...
def loss(X, sig):
    ...
    loss = g_sig_rho[:, 0] + (sig[:, 0] - sig[:, 1])/X[:,0]
...
def plot_displacement(network1, network2, scale_network_out, num_r, num_phi, s=20):
    ...
    ax2.plot(X_gl[0:-1:num_r, 0], press[0:-1:num_r, 0], 'r--', label = 'neural networks')
    ax2.plot(Xk,ans, label ='ansys')
    ax2.set_xlabel('$r$')
    ax2.set_ylabel('$\sigma(r) МПа$')
    plt.legend(loc='best')
...
loss_list_simple_net, simple_net1, simple_net2 = train_MultiFieldFracture_seperate_net(net1=simple_net1, net2=simple_net2,
                                                                      batch_size_X = num_1,
                                                                      max_iter = 5000,
                                                                      print_results_every = 1000, scale_network_out=scale_network_out, x_0= b, x_i = a, num_y=num_2)
